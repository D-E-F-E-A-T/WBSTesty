...
function wbstesty_scripts() {
	...
	wp_enqueue_script( 'wbstesty-fontawesome', 'https://use.fontawesome.com/982924c6e2.js');
...
class wbstesty_widget_latest_posts extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <?php while ( $r->have_posts() ) : $r->the_post(); ?>
            <li>
                <a href="<?php the_permalink(); ?>" class="last_posts_article_title"><?php get_the_title() ? the_title() : the_ID(); ?></a><br>
